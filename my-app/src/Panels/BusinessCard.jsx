                ...
                <div className="panel-body">
                    ...
                    <div className="row" style={{ marginTop: "0", paddingTop: "0", height: '43px' }}>
                        <div className="buttonDiv col-lg-3 col-md-3 col-xs-3">
                            <a title="אתר" href={emptyVal(gsx$website) ? 'javascript:void(0)' : gsx$website} className="btn btn-social-icon btn-facebook">
                                <span className="fa fa-fw fa-globe"></span>
                            </a>
                        </div>
                        <div className="buttonDiv col-lg-3 col-md-3 col-xs-3">
                            <a title="דף פייסבוק" href={emptyVal(gsx$facebook) ? 'javascript:void(0)' : gsx$facebook} className="btn btn-social-icon btn-facebook">
                                <span className="fa fa-fw fa-facebook"></span>
                            </a>
                        </div>
                        <div className="buttonDiv col-lg-3 col-md-3 col-xs-3">
                            <a title="דף אינסטגרם" href={emptyVal(gsx$instagram) ? 'javascript:void(0)' : gsx$instagram} className="btn btn-social-icon btn-instagram">
                                <span className="fa fa-fw fa-instagram"></span>
                            </a>
                        </div>
                        <div className="buttonDiv col-lg-3 col-md-3 col-xs-3">
                            <a title="ווטסאפ" href={emptyVal(gsx$whatsapp) ? 'javascript:void(0)' : whatsappURL + "send?phone=+972" + gsx$whatsapp} className="btn btn-social-icon btn-instagram" style={{ backgroundColor: "#06d755" }}>
